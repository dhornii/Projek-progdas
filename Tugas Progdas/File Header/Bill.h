...
class Bill {
    ...
    public: 
        ...
        void generateBill(){
            ...
            std:: cout << "Biaya jasa dokter: Rp " << jasa_dokter <<                    std:: endl          
                       << "Biaya jasa rumah sakit: Rp " << jasa_rs <<                   std:: endl
                       << "Biaya tindakan: Rp " << biaya_tindakan <<                    std:: endl
                       << "Biaya administrasi: Rp " << uang_administrasi <<             std:: endl
